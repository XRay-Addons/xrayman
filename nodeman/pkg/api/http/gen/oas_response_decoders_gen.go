...
func decodeAuthResponse(resp *http.Response) (res *AuthResponse, _ error) {
...
func decodeDeleteNodeResponse(resp *http.Response) (res *DeleteNodeResponse, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeDeleteUserResponse(resp *http.Response) (res *DeleteUserResponse, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
