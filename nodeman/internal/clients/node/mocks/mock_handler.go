...
// Source: github.com/XRay-Addons/xrayman/node/pkg/api/http/gen (interfaces: Handler)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_handler.go -package=mocks github.com/XRay-Addons/xrayman/node/pkg/api/http/gen Handler
//
