...
func (s *Performance) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	var failures []validate.FieldError
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.CpuLoad)); err != nil {
	...
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.RamLoad)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
	...
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.MemLoad)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
...
func (s *StartResponse) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
